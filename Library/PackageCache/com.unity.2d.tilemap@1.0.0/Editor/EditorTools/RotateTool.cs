...
namespace UnityEditor.Tilemaps
{
    ...
    public sealed class RotateClockwiseTool : RotateTool
    {
        private static class Styles
        {
            ...
            public static GUIContent toolContent = EditorGUIUtility.IconContent("Packages/com.unity.2d.tilemap/Editor/Icons/RotateClockwiseTool.png", GetTooltipText(tooltipStringFormat, shortcutId));
        }
    ...
    public sealed class RotateCounterClockwiseTool : RotateTool
    {
        private static class Styles
        {
            ...
            public static GUIContent toolContent = EditorGUIUtility.IconContent("Packages/com.unity.2d.tilemap/Editor/Icons/RotateCounterClockwiseTool.png", GetTooltipText(tooltipStringFormat, shortcutId));
        }
